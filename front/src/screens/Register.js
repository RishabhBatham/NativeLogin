...
return(
    <View style={{justifyContent:'center',position:'relative',alignItems:'center',flexDirection:'column'}}>
       ...
       <View style={{justifyContent:'center',alignItems:'center',flexDirection:'column'}}>
         ...
         <InputText /* icon={'phone'} */ setInputValue={setUserName} w={0.8} placeholder="your name..." iconSize={21} errorMessage={error.userName} error={error.userName} borderColor={'#fff'} backgroundColor={'#FFF'} borderRadius={18}/>
         </View>
         ...
         <InputText /* icon={'phone'}  se*/  inputMode={'numeric'} setInputValue={setUserNumber} errorMessage={error.userNumber} error={error.userNumber} w={0.8} placeholder="your phone number..." iconSize={21} borderColor={'#fff'} backgroundColor={'#FFF'} borderRadius={18}/>
         </View>

          <View style={{marginVertical:2}}>
            
         <Text style={{fontSize:16,color:'#666',paddingVertical:2,fontWeight:'500'}}>Password</Text>
         <InputText /* icon={'phone'} */   setInputValue={setUserPass} w={0.8} placeholder="your password..."  password={true} errorMessage={error.userPass} error={error.userPass} iconSize={21} borderColor={'#fff'} backgroundColor={'#FFF'} borderRadius={18}/>

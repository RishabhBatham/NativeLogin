...
return(
    <View style={{justifyContent:'center',position:'relative',alignItems:'center',flexDirection:'column'}}>
       ...
       <View style={{justifyContent:'center',alignItems:'center',flexDirection:'column'}}>
         ...
         <InputText setInputValue={setUserNumber} errorMessage={error.userNumber} error={error.userNumber} inputMode={'numeric'} icon={'phone'} w={0.8} placeholder="your phone number..." iconSize={21} borderColor={'#fff'} backgroundColor={'#FFF'} borderRadius={18}/>
         </View>

          <View style={{marginVertical:2}}>
            
         <Text style={{fontSize:16,color:'#666',paddingVertical:2,fontWeight:'500'}}>Password</Text>
         <InputText icon={'phone'} setInputValue={setUserPass} w={0.8} password={true} placeholder="your password..." iconSize={21} errorMessage={error.userPass} error={error.userPass} borderColor={'#fff'} backgroundColor={'#FFF'} borderRadius={18}/>
